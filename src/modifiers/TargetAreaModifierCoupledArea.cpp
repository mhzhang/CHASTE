...
TargetAreaModifierCoupledArea<DIM>::TargetAreaModifierCoupledArea()
...
template<unsigned DIM>
void TargetAreaModifierCoupledArea<DIM>::UpdateTargetAreaOfCell(CellPtr pCell)
{
...
template<unsigned DIM>
void TargetAreaModifierCoupledArea<DIM>::OutputSimulationModifierParameters(out_stream& rParamsFile)
{
...
template class TargetAreaModifierCoupledArea<1>;
template class TargetAreaModifierCoupledArea<2>;
template class TargetAreaModifierCoupledArea<3>;
