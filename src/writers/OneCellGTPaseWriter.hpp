...
#ifndef ONECELLGTPASEWRITER_HPP_
#define ONECELLGTPASEsWRITER_HPP_
...
class OneCellGTPaseWriter : public AbstractCellPopulationWriter<ELEMENT_DIM, SPACE_DIM>
{
private:
...
#endif /* ONECELLRACRHOWRITER_HPP_ */
